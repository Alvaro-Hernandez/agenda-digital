  ...
  useEffect(() => {
    const cargarStats = async () => {
      try {
        ...
        // Tareas pendientes (no completadas y fecha >= hoy)
        const tareasPendientes = tareas.filter(
          (t) => !t.completada && t.fechaVencimiento >= hoy
        ).length;

        // Eventos para hoy
        const eventosHoy = eventos.filter((e) => e.fecha === hoy).length;

        // Exámenes para hoy (tipo === "examen" y fecha === hoy)
        const examenesHoy = eventos.filter(
          (e) => e.tipo === "examen" && e.fecha === hoy
        ).length;

        setStats({ tareasPendientes, eventosHoy, examenesHoy });
      } catch (error) {
    ...
    <ScrollView style={styles.container} showsVerticalScrollIndicator={false}>
      ...
      <View style={styles.headerContainer}>
        <View style={styles.welcomeSection}>
          ...
          <Text style={styles.subtitle}>
            Tu compañero perfecto para el éxito académico
          </Text>
        </View>
      </View>
      ...
      <View style={styles.statsContainer}>
        ...
        <View style={styles.statCard}>
          ...
          <Text style={styles.statNumber}>{stats.eventosHoy}</Text>
          <Text style={styles.statLabel}>Eventos hoy</Text>
        </View>
        <View style={styles.statCard}>
          <Ionicons name="school-outline" size={24} color="#e17055" />
          <Text style={styles.statNumber}>{stats.examenesHoy}</Text>
          <Text style={styles.statLabel}>Exámenes hoy</Text>
        </View>
      </View>
        ...
        <View style={styles.modulesContainer}>
          ...
          >
            ...
            <View style={styles.moduleContent}>
              ...
              <Text style={styles.moduleDesc}>
                Organiza materias, horarios y eventos académicos
              </Text>
          ...
          >
            ...
            <View style={styles.moduleContent}>
              ...
              <Text style={styles.moduleDesc}>
                Gestiona tareas, exámenes y recibe alertas
              </Text>
              <View style={styles.moduleFeatures}>
                <View style={styles.feature}>
                  <Ionicons
